...
describe Payroc::Internal::Types::Model do
  ...
  class ExampleModel < Payroc::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Payroc::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Payroc::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Payroc::Internal::Types::Model
