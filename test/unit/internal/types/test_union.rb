...
describe Payroc::Internal::Types::Union do
  class Rectangle < Payroc::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Payroc::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Payroc::Internal::Types::Model
