...
describe Payroc::Internal::Types::Utils do
  Utils = Payroc::Internal::Types::Utils

  module TestUtils
    class M < Payroc::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Payroc::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Payroc::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Payroc::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Payroc::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Payroc::Internal::Types::Array[String]
      ModelArray = -> { Payroc::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Payroc::Internal::Types::Array[TestUtils::U] }
