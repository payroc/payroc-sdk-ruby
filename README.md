...
client = Payroc::Client.new(
  environment: Payroc::Environment::PRODUCTION,
  api_key: api_key
)
```
...
Refer to the [reference documentation](https://github.com/payroc/payroc-sdk-ruby/blob/HEAD/./reference.md) to see what parameters are available for each method.
...
A full reference for this library is available [here](https://github.com/payroc/payroc-sdk-ruby/blob/HEAD/./reference.md).

The Payroc API SDK is generated via [Fern](https://www.buildwithfern.com/).

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=https%3A%2F%2Fgithub.com%2Fpayroc%2Fpayroc-sdk-ruby)
