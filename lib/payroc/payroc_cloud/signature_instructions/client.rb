    ...
    module SignatureInstructions
      class Client
        ...
        def submit(request_options: {}, **params)
          ...
          request_data = Payroc::PayrocCloud::SignatureInstructions::Types::SignatureInstructionRequest.new(params).to_h
          ...
          request = Payroc::Internal::JSON::Request.new(
            ...
            method: "POST",
            path: "devices/#{URI.encode_uri_component(params[:serial_number].to_s)}/signature-instructions",
            headers: headers,
            body: body,
        ...
        def retrieve(request_options: {}, **params)
          ...
          request = Payroc::Internal::JSON::Request.new(
            base_url: request_options[:base_url] || @base_url || @environment&.dig(:api),
            method: "GET",
            path: "signature-instructions/#{URI.encode_uri_component(params[:signature_instruction_id].to_s)}",
            request_options: request_options
          )
          begin
            response = @client.send(request)
