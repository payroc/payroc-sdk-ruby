    ...
    module Payments
      module Types
        class ListPaymentsRequest < Internal::Types::Model
          ...
          field :type, -> { Payroc::BankTransferPayments::Payments::Types::ListPaymentsRequestTypeItem }, optional: true, nullable: false
          field :status, -> { Payroc::BankTransferPayments::Payments::Types::ListPaymentsRequestStatusItem }, optional: true, nullable: false
          ...
          field :settlement_state, -> { Payroc::BankTransferPayments::Payments::Types::ListPaymentsRequestSettlementState }, optional: true, nullable: false, api_name: "settlementState"
