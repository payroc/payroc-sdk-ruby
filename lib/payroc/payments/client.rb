...
module Payroc
  module Payments
    class Client
      ...
      # @option params [Payroc::Payments::Types::ListPaymentsRequestTender, nil] :tender
      # @option params [Payroc::Payments::Types::ListPaymentsRequestTipModeItem, nil] :tip_mode
      # @option params [Payroc::Payments::Types::ListPaymentsRequestTypeItem, nil] :type
      # @option params [Payroc::Payments::Types::ListPaymentsRequestStatusItem, nil] :status
      # @option params [String, nil] :date_from
      # @option params [String, nil] :date_to
      # @option params [Payroc::Payments::Types::ListPaymentsRequestSettlementState, nil] :settlement_state
      ...
      #
      # In the response, our gateway returns information about the card payment and a paymentId, which you need for the
      # following methods:
      #
      # -	[Retrieve payment](https://docs.payroc.com/api/schema/card-payments/payments/retrieve) - View the details of
      # the card payment.
      # -	[Adjust payment](https://docs.payroc.com/api/schema/card-payments/payments/adjust) - Update the details of the
      # card payment.
      # -	[Capture payment](https://docs.payroc.com/api/schema/card-payments/payments/capture)  - Capture the
      # pre-authorization.
      # -	[Reverse payment](https://docs.payroc.com/api/schema/card-payments/refunds/reverse)  - Cancel the card payment
      # if it's in an open batch.
      ...
      #
      # @param request_options [Hash]
      # @param params [Payroc::Payments::Types::PaymentRequest]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def create(request_options: {}, **params)
        ...
        request = Payroc::Internal::JSON::Request.new(
          ...
          method: "POST",
          path: "payments",
          body: Payroc::Payments::Types::PaymentRequest.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      #
      # To retrieve a payment, you need its paymentId. Our gateway returned the paymentId in the response of the [Create
      ...
      #
      # Our gateway returns information about the adjusted payment, including information about the payment card and the
      # cardholder.
      #
      # @param request_options [Hash]
      # @param params [Payroc::Payments::Types::PaymentAdjustment]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def adjust(request_options: {}, **params)
        ...
        request = Payroc::Internal::JSON::Request.new(
          ...
          body: Payroc::Payments::Types::PaymentAdjustment.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      #
      # @param request_options [Hash]
      # @param params [Payroc::Payments::Types::PaymentCapture]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def capture(request_options: {}, **params)
        ...
        request = Payroc::Internal::JSON::Request.new(
          ...
          body: Payroc::Payments::Types::PaymentCapture.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      #
      # @param request_options [Hash]
      # @param params [Payroc::Payments::Types::PaymentReversal]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def reverse(request_options: {}, **params)
        ...
        request = Payroc::Internal::JSON::Request.new(
          ...
          body: Payroc::Payments::Types::PaymentReversal.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      # - Some merchants can run unreferenced refunds, which means that they don't need a paymentId to return an amount
      # to a customer. For more information about how to run an unreferenced refund, go to [Create
      # Refund](https://docs.payroc.com/api/schema/card-payments/refunds/create-unreferenced-refund).
      #
      # @param request_options [Hash]
      # @param params [Payroc::Payments::Types::ReferencedRefund]
      # @option request_options [String] :base_url
      # @option request_options [Hash{String => Object}] :additional_headers
      # @option request_options [Hash{String => Object}] :additional_query_parameters
      # @option request_options [Hash{String => Object}] :additional_body_parameters
      ...
      def refund(request_options: {}, **params)
        ...
        request = Payroc::Internal::JSON::Request.new(
          ...
          body: Payroc::Payments::Types::ReferencedRefund.new(body_bag).to_h,
          request_options: request_options
        )
        begin
          response = @client.send(request)
      ...
      def payment_links
        @payment_links ||= Payroc::Payments::PaymentLinks::Client.new(client: @client)
      end

      # @return [Payroc::PaymentPlans::Client]
      def payment_plans
        @payment_plans ||= Payroc::Payments::PaymentPlans::Client.new(client: @client)
      end

      # @return [Payroc::Subscriptions::Client]
      def subscriptions
        @subscriptions ||= Payroc::Payments::Subscriptions::Client.new(client: @client)
      end

      # @return [Payroc::SecureTokens::Client]
      def secure_tokens
        @secure_tokens ||= Payroc::Payments::SecureTokens::Client.new(client: @client)
      end

      # @return [Payroc::SingleUseTokens::Client]
      def single_use_tokens
        @single_use_tokens ||= Payroc::Payments::SingleUseTokens::Client.new(client: @client)
      end

      # @return [Payroc::HostedFields::Client]
      def hosted_fields
        @hosted_fields ||= Payroc::Payments::HostedFields::Client.new(client: @client)
      end

      # @return [Payroc::ApplePaySessions::Client]
      def apple_pay_sessions
        @apple_pay_sessions ||= Payroc::Payments::ApplePaySessions::Client.new(client: @client)
      end

      # @return [Payroc::Refunds::Client]
      def refunds
        @refunds ||= Payroc::Payments::Refunds::Client.new(client: @client)
      end

      # @return [Payroc::Signatures::Client]
      def signatures
        @signatures ||= Payroc::Payments::Signatures::Client.new(client: @client)
      end

      # @return [Payroc::Cards::Client]
      def cards
        @cards ||= Payroc::Payments::Cards::Client.new(client: @client)
      end

      # @return [Payroc::CurrencyConversion::Client]
      def currency_conversion
        @currency_conversion ||= Payroc::Payments::CurrencyConversion::Client.new(client: @client)
      end

      # @return [Payroc::BankTransferPayments::Client]
      def bank_transfer_payments
        @bank_transfer_payments ||= Payroc::Payments::BankTransferPayments::Client.new(client: @client)
      end

      # @return [Payroc::BankTransferRefunds::Client]
      def bank_transfer_refunds
        @bank_transfer_refunds ||= Payroc::Payments::BankTransferRefunds::Client.new(client: @client)
      end

      # @return [Payroc::BankAccounts::Client]
      def bank_accounts
        @bank_accounts ||= Payroc::Payments::BankAccounts::Client.new(client: @client)
      end
    end
  end
end
