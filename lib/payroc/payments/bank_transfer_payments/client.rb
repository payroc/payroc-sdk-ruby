  ...
  module Payments
    module BankTransferPayments
      class Client
        ...
        # @option params [Payroc::Payments::BankTransferPayments::Types::ListBankTransferPaymentsRequestTypeItem, nil] :type
        # @option params [Payroc::Payments::BankTransferPayments::Types::ListBankTransferPaymentsRequestStatusItem, nil] :status
        # @option params [String, nil] :date_from
        # @option params [String, nil] :date_to
        # @option params [Payroc::Payments::BankTransferPayments::Types::ListBankTransferPaymentsRequestSettlementState, nil] :settlement_state
        ...
        # -	[Refund payment](https://docs.payroc.com/api/schema/bank-transfer-payments/refunds/create-referenced-refund)
        # - Run a referenced refund to return funds to the customer's bank account.
        #
        # **Payment methods**
        #
        ...
        #
        # @param request_options [Hash]
        # @param params [Payroc::Payments::BankTransferPayments::Types::BankTransferPaymentRequest]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        def create(request_options: {}, **params)
          ...
          request = Payroc::Internal::JSON::Request.new(
            ...
            method: "POST",
            path: "bank-transfer-payments",
            body: Payroc::Payments::BankTransferPayments::Types::BankTransferPaymentRequest.new(body_bag).to_h,
            request_options: request_options
          )
          begin
            response = @client.send(request)
        ...
        # Refund](https://docs.payroc.com/api/schema/bank-transfer-payments/refunds/create-unreferenced-refund).
        #
        # @param request_options [Hash]
        # @param params [Payroc::Payments::BankTransferPayments::Types::BankTransferReferencedRefund]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        def refund(request_options: {}, **params)
          ...
          request = Payroc::Internal::JSON::Request.new(
            ...
            body: Payroc::Payments::BankTransferPayments::Types::BankTransferReferencedRefund.new(body_bag).to_h,
            request_options: request_options
          )
          begin
            response = @client.send(request)
        ...
        #
        # @param request_options [Hash]
        # @param params [Payroc::Payments::BankTransferPayments::Types::Representment]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        def represent(request_options: {}, **params)
          ...
          request = Payroc::Internal::JSON::Request.new(
            ...
            body: Payroc::Payments::BankTransferPayments::Types::Representment.new(body_bag).to_h,
            request_options: request_options
          )
          begin
            response = @client.send(request)
