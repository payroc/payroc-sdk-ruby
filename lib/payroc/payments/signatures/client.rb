  ...
  module Payments
    module Signatures
      class Client
        ...
        #
        # @return [Payroc::Payments::Signatures::Types::RetrieveSignaturesResponse]
        def retrieve(request_options: {}, **params)
          request = Payroc::Internal::JSON::Request.new(
            base_url: request_options[:base_url] || Payroc::Environment::PRODUCTION,
            method: "GET",
            path: "signatures/#{params[:signature_id]}",
          ...
          if code.between?(200, 299)
            Payroc::Payments::Signatures::Types::RetrieveSignaturesResponse.load(response.body)
          else
