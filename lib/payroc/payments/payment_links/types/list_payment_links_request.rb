    ...
    module PaymentLinks
      module Types
        class ListPaymentLinksRequest < Internal::Types::Model
          ...
          field :link_type, -> { Payroc::Payments::PaymentLinks::Types::ListPaymentLinksRequestLinkType }, optional: true, nullable: false, api_name: "linkType"
          field :charge_type, -> { Payroc::Payments::PaymentLinks::Types::ListPaymentLinksRequestChargeType }, optional: true, nullable: false, api_name: "chargeType"
          field :status, -> { Payroc::Payments::PaymentLinks::Types::ListPaymentLinksRequestStatus }, optional: true, nullable: false
