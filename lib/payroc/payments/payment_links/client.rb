  ...
  module Payments
    module PaymentLinks
      class Client
        ...
        # Use this method to return a [paginated](https://docs.payroc.com/api/pagination) list of payment links linked
        ...
        # [Retrieve Payment Link](https://docs.payroc.com/api/schema/payments/payment-links/retrieve) method.
        #
        # Use query parameters to filter the list of results that we return, for example, to search for only active
        # links or multi-use links.
        #
        ...
        # @option params [Payroc::Payments::PaymentLinks::Types::ListPaymentLinksRequestLinkType, nil] :link_type
        # @option params [Payroc::Payments::PaymentLinks::Types::ListPaymentLinksRequestChargeType, nil] :charge_type
        # @option params [Payroc::Payments::PaymentLinks::Types::ListPaymentLinksRequestStatus, nil] :status
        ...
        # Link](https://docs.payroc.com/api/schema/payments/payment-links/sharing-events/share) method.
        #
        # @param request_options [Hash]
        # @param params [Payroc::Payments::PaymentLinks::Types::CreatePaymentLinksRequestBody]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        #
        # @return [Payroc::Payments::PaymentLinks::Types::CreatePaymentLinksResponse]
        def create(request_options: {}, **params)
          ...
          request = Payroc::Internal::JSON::Request.new(
            ...
            method: "POST",
            path: "processing-terminals/#{params[:processing_terminal_id]}/payment-links",
            body: Payroc::Payments::PaymentLinks::Types::CreatePaymentLinksRequestBody.new(body_params).to_h,
            request_options: request_options
          )
          begin
            response = @client.send(request)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Payroc::Payments::PaymentLinks::Types::CreatePaymentLinksResponse.load(response.body)
          else
            error_class = Payroc::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        # Links](https://docs.payroc.com/api/schema/payments/payment-links/list) method to search for the payment link.
        #
        ...
        #
        # @return [Payroc::Payments::PaymentLinks::Types::RetrievePaymentLinksResponse]
        def retrieve(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Payroc::Payments::PaymentLinks::Types::RetrievePaymentLinksResponse.load(response.body)
          else
            error_class = Payroc::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        # @option params [String] :idempotency_key
        #
        # @return [Payroc::Payments::PaymentLinks::Types::PartiallyUpdatePaymentLinksResponse]
        def partially_update(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Payroc::Payments::PaymentLinks::Types::PartiallyUpdatePaymentLinksResponse.load(response.body)
          else
            error_class = Payroc::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        #
        # To deactivate a payment link, you need its paymentLinkId. Our gateway returned the paymentLinkId in the
        # response of the [Create Payment Link](https://docs.payroc.com/api/schema/payments/payment-links/create)
        # method.
        #
        # **Note:** If you don't have the paymentLinkId, use our [List Payment
        # Links](https://docs.payroc.com/api/schema/payments/payment-links/list) method to search for the payment link.
        #
        # If your request is successful, our gateway deactivates the payment link. The customer can't use the link to
        # make a payment, and you can't reactivate the payment link.
        #
        # @param request_options [Hash]
        # @param params [Hash]
        # @option request_options [String] :base_url
        ...
        # @option params [String] :payment_link_id
        #
        # @return [Payroc::Payments::PaymentLinks::Types::DeactivatePaymentLinksResponse]
        def deactivate(request_options: {}, **params)
          ...
          code = response.code.to_i
          if code.between?(200, 299)
            Payroc::Payments::PaymentLinks::Types::DeactivatePaymentLinksResponse.load(response.body)
          else
            error_class = Payroc::Errors::ResponseError.subclass_for_code(code)
            raise error_class.new(response.body, code: code)
          end
        ...
        def sharing_events
          @sharing_events ||= Payroc::Payments::PaymentLinks::SharingEvents::Client.new(client: @client)
        end
      end
    end
  end
