  ...
  module PaymentLinks
    module SharingEvents
      class Client
        ...
        #
        # Use query parameters to filter the list of results that we return, for example, to search for links sent to a
        # specific customer.
        #
        ...
        #
        # To email a payment link, you need its paymentLinkId. Our gateway returned the paymentLinkId in the response of
        # the [Create Payment Link](https://docs.payroc.com/api/schema/payment-links/create) method.
        #
        # **Note:** If you don't have the paymentLinkId, use our [List Payment
        # Links](https://docs.payroc.com/api/schema/payment-links/list) method to search for the payment link.
        #
