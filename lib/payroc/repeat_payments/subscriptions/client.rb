  ...
  module RepeatPayments
    module Subscriptions
      class Client
        ...
        # @option params [Payroc::RepeatPayments::Subscriptions::Types::ListSubscriptionsRequestFrequency, nil] :frequency
        # @option params [Payroc::RepeatPayments::Subscriptions::Types::ListSubscriptionsRequestStatus, nil] :status
        ...
        #
        # @param request_options [Hash]
        # @param params [Payroc::RepeatPayments::Subscriptions::Types::SubscriptionRequest]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        # in follow-on actions with the [Payments](https://docs.payroc.com/api/schema/card-payments/payments) endpoints
        # or [Bank Transfer Payments](https://docs.payroc.com/api/schema/bank-transfer-payments/payments) endpoints.
        #
        # @param request_options [Hash]
        # @param params [Payroc::RepeatPayments::Subscriptions::Types::SubscriptionPaymentRequest]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
