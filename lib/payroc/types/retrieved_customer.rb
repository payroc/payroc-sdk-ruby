...
module Payroc
  module Types
    ...
    class RetrievedCustomer < Internal::Types::Model
      ...
      field :billing_address, -> { Payroc::Types::RetrievedAddress }, optional: true, nullable: false, api_name: "billingAddress"
      field :shipping_address, -> { Payroc::Types::RetrievedShipping }, optional: true, nullable: false, api_name: "shippingAddress"
      ...
      field :notification_language, -> { Payroc::Types::RetrievedCustomerNotificationLanguage }, optional: true, nullable: false, api_name: "notificationLanguage"
    end
  end
end
