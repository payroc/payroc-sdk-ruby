...
require_relative "lib/payroc/version"
...
Gem::Specification.new do |spec|
  spec.name = "payroc"
  spec.authors = ["Payroc"]
  spec.version = Payroc::VERSION
  spec.summary = "Ruby client library for the Payroc API"
  spec.description = "The Payroc Ruby library provides convenient access to the Payroc API from Ruby."
