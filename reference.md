# Reference
## Payments
<details><summary><code>client.payments.list() -> Payroc::Types::PaymentPaginatedListForRead</code></summary>
<dl>
<dd>
...
**tender:** `Payroc::Payments::Types::ListPaymentsRequestTender` — Filter by tender type.
...
**tip_mode:** `Payroc::Payments::Types::ListPaymentsRequestTipModeItem` — Filter payments by tip.
...
**type:** `Payroc::Payments::Types::ListPaymentsRequestTypeItem` — Filter payments by transaction type.
...
**status:** `Payroc::Payments::Types::ListPaymentsRequestStatusItem` — Filter payments by the status of the transaction.
...
**settlement_state:** `Payroc::Payments::Types::ListPaymentsRequestSettlementState` — Filter payments by the settlement status of the transaction.
...
<details><summary><code>client.payments.create(request) -> Payroc::Types::Payment</code></summary>
<dl>
<dd>
...
**channel:** `Payroc::Payments::Types::PaymentRequestChannel` — Channel that the merchant used to receive the payment details.
...
**payment_method:** `Payroc::Payments::Types::PaymentRequestPaymentMethod` — Object that contains information about the customer's payment details.
...
**three_d_secure:** `Payroc::Payments::Types::PaymentRequestThreeDSecure` — Object that contains information for an authentication check on the customer's payment details using the 3-D Secure protocol.
...
<details><summary><code>client.payments.retrieve(payment_id) -> Payroc::Types::RetrievedPayment</code></summary>
<dl>
<dd>
...
```ruby
client.payments.retrieve(payment_id: 'M2MJOG6O2Y');
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.payments.adjust(payment_id, request) -> Payroc::Types::Payment</code></summary>
<dl>
<dd>
...
**adjustments:** `Internal::Types::Array[Payroc::Payments::Types::PaymentAdjustmentAdjustmentsItem]` — Array of objects that contain information about the adjustments to the payment.
...
<details><summary><code>client.payments.capture(payment_id, request) -> Payroc::Types::Payment</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.reverse(payment_id, request) -> Payroc::Types::Payment</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.refund(payment_id, request) -> Payroc::Types::Payment</code></summary>
<dl>
<dd>
...
## Auth
<details><summary><code>client.auth.retrieve_token() -> Payroc::Auth::Types::GetTokenResponse</code></summary>
<dl>
<dd>
...
## Boarding Owners
<details><summary><code>client.boarding.owners.retrieve(owner_id) -> Payroc::Types::Owner</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.owners.update(owner_id, request) -> </code></summary>
<dl>
<dd>
...
```ruby
client.boarding.owners.update(owner_id: 1);
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.boarding.owners.delete(owner_id) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.pricing_intents.list() -> Payroc::Types::PaginatedPricingIntent</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.pricing_intents.create(request) -> Payroc::Types::PricingIntent50</code></summary>
<dl>
<dd>
...
```ruby
client.boarding.pricing_intents.create(idempotency_key: '8e03978e-40d5-43e8-bc93-6894a57f9324');
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.boarding.pricing_intents.retrieve(pricing_intent_id) -> Payroc::Types::PricingIntent50</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.pricing_intents.update(pricing_intent_id, request) -> </code></summary>
<dl>
<dd>
...
```ruby
client.boarding.pricing_intents.update(pricing_intent_id: '5');
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.boarding.pricing_intents.delete(pricing_intent_id) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.pricing_intents.partially_update(pricing_intent_id, request) -> Payroc::Types::PricingIntent50</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.merchant_platforms.list() -> Payroc::Types::PaginatedMerchants</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.merchant_platforms.create(request) -> Payroc::Types::MerchantPlatform</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.merchant_platforms.retrieve(merchant_platform_id) -> Payroc::Types::MerchantPlatform</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.merchant_platforms.list_processing_accounts(merchant_platform_id) -> Payroc::Types::PaginatedProcessingAccounts</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.merchant_platforms.create_processing_account(merchant_platform_id, request) -> Payroc::Types::ProcessingAccount</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.processing_accounts.retrieve(processing_account_id) -> Payroc::Types::ProcessingAccount</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.processing_accounts.list_processing_account_funding_accounts(processing_account_id) -> Internal::Types::Array[Payroc::Types::FundingAccount]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.processing_accounts.list_contacts(processing_account_id) -> Payroc::Types::PaginatedContacts</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.processing_accounts.get_processing_account_pricing_agreement(processing_account_id) -> Payroc::Boarding::ProcessingAccounts::Types::GetProcessingAccountPricingAgreementProcessingAccountsResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.processing_accounts.list_owners(processing_account_id) -> Payroc::Types::PaginatedOwners</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.processing_accounts.create_reminder(processing_account_id, request) -> Payroc::Boarding::ProcessingAccounts::Types::CreateReminderProcessingAccountsResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.processing_accounts.list_terminal_orders(processing_account_id) -> Internal::Types::Array[Payroc::Types::TerminalOrder]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.processing_accounts.create_terminal_order(processing_account_id, request) -> Payroc::Types::TerminalOrder</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.processing_accounts.list_processing_terminals(processing_account_id) -> Payroc::Types::PaginatedProcessingTerminals</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.processing_terminals.retrieve(processing_terminal_id) -> Payroc::Types::ProcessingTerminal</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.processing_terminals.retrieve_host_configuration(processing_terminal_id) -> Payroc::Types::HostConfiguration</code></summary>
<dl>
<dd>
...
## Boarding Contacts
<details><summary><code>client.boarding.contacts.retrieve(contact_id) -> Payroc::Types::Contact</code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.contacts.update(contact_id, request) -> </code></summary>
<dl>
<dd>
...
```ruby
client.boarding.contacts.update(contact_id: 1);
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.boarding.contacts.delete(contact_id) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.boarding.terminal_orders.retrieve(terminal_order_id) -> Payroc::Types::TerminalOrder</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_recipients.list() -> Payroc::Types::PaginatedFundRecipients</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_recipients.create(request) -> Payroc::Types::FundingRecipient</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_recipients.retrieve(recipient_id) -> Payroc::Types::FundingRecipient</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_recipients.update(recipient_id, request) -> </code></summary>
<dl>
<dd>
...
```ruby
client.funding.funding_recipients.update(recipient_id: 1);
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.funding.funding_recipients.delete(recipient_id) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_recipients.list_accounts(recipient_id) -> Internal::Types::Array[Payroc::Types::FundingAccount]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_recipients.create_account(recipient_id, request) -> Payroc::Types::FundingAccount</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_recipients.list_owners(recipient_id) -> Internal::Types::Array[Payroc::Types::Owner]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_recipients.create_owner(recipient_id, request) -> Payroc::Types::Owner</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_accounts.list() -> Payroc::Types::ListFundingAccounts</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_accounts.retrieve(funding_account_id) -> Payroc::Types::FundingAccount</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_accounts.update(funding_account_id, request) -> </code></summary>
<dl>
<dd>
...
```ruby
client.funding.funding_accounts.update(funding_account_id: 1);
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.funding.funding_accounts.delete(funding_account_id) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_instructions.list() -> Payroc::Funding::FundingInstructions::Types::ListFundingInstructionsResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_instructions.create(request) -> Payroc::Types::Instruction</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_instructions.retrieve(instruction_id) -> Payroc::Types::Instruction</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_instructions.update(instruction_id, request) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_instructions.delete(instruction_id) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_activity.retrieve_balance() -> Payroc::Funding::FundingActivity::Types::RetrieveBalanceFundingActivityResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.funding.funding_activity.list() -> Payroc::Funding::FundingActivity::Types::ListFundingActivityResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.notifications.event_subscriptions.list() -> Payroc::Types::PaginatedEventSubscriptions</code></summary>
<dl>
<dd>
...
```ruby
client.notifications.event_subscriptions.list(event: 'processingAccount.status.changed');
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.notifications.event_subscriptions.create(request) -> Payroc::Types::EventSubscription</code></summary>
<dl>
<dd>
...
<details><summary><code>client.notifications.event_subscriptions.retrieve(subscription_id) -> Payroc::Types::EventSubscription</code></summary>
<dl>
<dd>
...
<details><summary><code>client.notifications.event_subscriptions.update(subscription_id, request) -> </code></summary>
<dl>
<dd>
...
```ruby
client.notifications.event_subscriptions.update(subscription_id: 1);
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.notifications.event_subscriptions.delete(subscription_id) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.notifications.event_subscriptions.partially_update(subscription_id, request) -> Payroc::Types::EventSubscription</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.payment_links.list(processing_terminal_id) -> Payroc::Types::PaymentLinkPaginatedList</code></summary>
<dl>
<dd>
...
**link_type:** `Payroc::Payments::PaymentLinks::Types::ListPaymentLinksRequestLinkType` — Filter results by the type of link. Send a value of <code>singleUse</code> or <code>multiUse</code>.
...
**charge_type:** `Payroc::Payments::PaymentLinks::Types::ListPaymentLinksRequestChargeType` 
...
**status:** `Payroc::Payments::PaymentLinks::Types::ListPaymentLinksRequestStatus` — Filter results by the status of the payment link. Send a value of <code>active</code>, <code>completed</code>,<code>deactived</code>, or <code>expired</code>.
...
<details><summary><code>client.payments.payment_links.create(processing_terminal_id, request) -> Payroc::Payments::PaymentLinks::Types::CreatePaymentLinksResponse</code></summary>
<dl>
<dd>
...
**request:** `Payroc::Payments::PaymentLinks::Types::CreatePaymentLinksRequestBody` 
...
<details><summary><code>client.payments.payment_links.retrieve(payment_link_id) -> Payroc::Payments::PaymentLinks::Types::RetrievePaymentLinksResponse</code></summary>
<dl>
<dd>
...
```ruby
client.payments.payment_links.retrieve(payment_link_id: 'JZURRJBUPS');
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.payments.payment_links.partially_update(payment_link_id, request) -> Payroc::Payments::PaymentLinks::Types::PartiallyUpdatePaymentLinksResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.payment_links.deactivate(payment_link_id) -> Payroc::Payments::PaymentLinks::Types::DeactivatePaymentLinksResponse</code></summary>
<dl>
<dd>
...
```ruby
client.payments.payment_links.deactivate(payment_link_id: 'JZURRJBUPS');
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.payments.payment_plans.list(processing_terminal_id) -> Payroc::Types::PaymentPlanPaginatedList</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.payment_plans.create(processing_terminal_id, request) -> Payroc::Types::PaymentPlan</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.payment_plans.retrieve(processing_terminal_id, payment_plan_id) -> Payroc::Types::PaymentPlan</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.payment_plans.delete(processing_terminal_id, payment_plan_id) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.payment_plans.partially_update(processing_terminal_id, payment_plan_id, request) -> Payroc::Types::PaymentPlan</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.subscriptions.list(processing_terminal_id) -> Payroc::Types::SubscriptionPaginatedList</code></summary>
<dl>
<dd>
...
**frequency:** `Payroc::Payments::Subscriptions::Types::ListSubscriptionsRequestFrequency` — Filter by the frequency of subscription payments.
...
**status:** `Payroc::Payments::Subscriptions::Types::ListSubscriptionsRequestStatus` — Filter by the current status of the subscription.
...
<details><summary><code>client.payments.subscriptions.create(processing_terminal_id, request) -> Payroc::Types::Subscription</code></summary>
<dl>
<dd>
...
**payment_method:** `Payroc::Payments::Subscriptions::Types::SubscriptionRequestPaymentMethod` — Object that contains information about the customer's payment details.
...
<details><summary><code>client.payments.subscriptions.retrieve(processing_terminal_id, subscription_id) -> Payroc::Types::Subscription</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.subscriptions.partially_update(processing_terminal_id, subscription_id, request) -> Payroc::Types::Subscription</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.subscriptions.deactivate(processing_terminal_id, subscription_id) -> Payroc::Types::Subscription</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.subscriptions.reactivate(processing_terminal_id, subscription_id) -> Payroc::Types::Subscription</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.subscriptions.pay(processing_terminal_id, subscription_id, request) -> Payroc::Types::SubscriptionPayment</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.secure_tokens.list(processing_terminal_id) -> Payroc::Types::SecureTokenPaginatedListWithAccountType</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.secure_tokens.create(processing_terminal_id, request) -> Payroc::Types::SecureToken</code></summary>
<dl>
<dd>
...
**mit_agreement:** `Payroc::Payments::SecureTokens::Types::TokenizationRequestMitAgreement` 
...
**source:** `Payroc::Payments::SecureTokens::Types::TokenizationRequestSource` — Object that contains information about the payment method to tokenize.
...
**three_d_secure:** `Payroc::Payments::SecureTokens::Types::TokenizationRequestThreeDSecure` — Object that contains information for an authentication check on the customer's payment details using the 3-D Secure protocol.
...
<details><summary><code>client.payments.secure_tokens.retrieve(processing_terminal_id, secure_token_id) -> Payroc::Types::SecureTokenWithAccountType</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.secure_tokens.delete(processing_terminal_id, secure_token_id) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.secure_tokens.partially_update(processing_terminal_id, secure_token_id, request) -> Payroc::Types::SecureToken</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.secure_tokens.update_account(processing_terminal_id, secure_token_id, request) -> Payroc::Types::SecureToken</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.single_use_tokens.create(processing_terminal_id, request) -> Payroc::Types::SingleUseToken</code></summary>
<dl>
<dd>
...
```ruby
client.payments.single_use_tokens.create(
  processing_terminal_id: '1234001',
  idempotency_key: '8e03978e-40d5-43e8-bc93-6894a57f9324',
  operator: 'Jane'
);
...
**channel:** `Payroc::Payments::SingleUseTokens::Types::SingleUseTokenRequestChannel` — Channel that the merchant used to receive the payment details.
...
**source:** `Payroc::Payments::SingleUseTokens::Types::SingleUseTokenRequestSource` — Object that contains information about the payment method to tokenize.
...
<details><summary><code>client.payments.hosted_fields.create(processing_terminal_id, request) -> Payroc::Types::HostedFieldsCreateSessionResponse</code></summary>
<dl>
<dd>
...
**scenario:** `Payroc::Payments::HostedFields::Types::HostedFieldsCreateSessionRequestScenario` 
...
<details><summary><code>client.payments.apple_pay_sessions.create(processing_terminal_id, request) -> Payroc::Types::ApplePayResponseSession</code></summary>
<dl>
<dd>
...
```ruby
client.payments.apple_pay_sessions.create(
  processing_terminal_id: '1234001',
...
**apple_domain_id:** `String` — Unique identifier of the merchant's domain that we assigned when you added their domain to our Self-Care Portal.
...
## Payments Refunds
<details><summary><code>client.payments.refunds.list() -> Payroc::Types::RefundPaginatedList</code></summary>
<dl>
<dd>
...
**tender:** `Payroc::Payments::Refunds::Types::ListRefundsRequestTender` — Filter by tender type.
...
**status:** `Payroc::Payments::Refunds::Types::ListRefundsRequestStatusItem` — Filter refunds by the current status of the refund.
...
**settlement_state:** `Payroc::Payments::Refunds::Types::ListRefundsRequestSettlementState` — Status of the settlement.
...
<details><summary><code>client.payments.refunds.create(request) -> Payroc::Types::RetrievedRefund</code></summary>
<dl>
<dd>
...
**channel:** `Payroc::Payments::Refunds::Types::UnreferencedRefundChannel` — Channel that the merchant used to request the refund.
...
**refund_method:** `Payroc::Payments::Refunds::Types::UnreferencedRefundRefundMethod` — Object that contains information about how the merchant refunds the customer.
...
<details><summary><code>client.payments.refunds.retrieve(refund_id) -> Payroc::Types::RetrievedRefund</code></summary>
<dl>
<dd>
...
```ruby
client.payments.refunds.retrieve(refund_id: 'CD3HN88U9F');
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.payments.refunds.adjust(refund_id, request) -> Payroc::Types::RetrievedRefund</code></summary>
<dl>
<dd>
...
**adjustments:** `Internal::Types::Array[Payroc::Payments::Refunds::Types::RefundAdjustmentAdjustmentsItem]` — Array of objects that contain information about the adjustments to the refund.
...
<details><summary><code>client.payments.refunds.reverse(refund_id) -> Payroc::Types::RetrievedRefund</code></summary>
<dl>
<dd>
...
## Payments Signatures
<details><summary><code>client.payments.signatures.retrieve(signature_id) -> Payroc::Payments::Signatures::Types::RetrieveSignaturesResponse</code></summary>
<dl>
<dd>
...
```ruby
client.payments.signatures.retrieve(signature_id: 'JDN4ILZB0T');
```
</dd>
</dl>
</dd>
...
## Payments Cards
<details><summary><code>client.payments.cards.verify(request) -> Payroc::Types::CardVerificationResult</code></summary>
<dl>
<dd>
...
**card:** `Payroc::Payments::Cards::Types::CardVerificationRequestCard` — Object that contains information about the card.
...
<details><summary><code>client.payments.cards.view_balance(request) -> Payroc::Types::Balance</code></summary>
<dl>
<dd>
...
```ruby
client.payments.cards.view_balance(
  processing_terminal_id: '1234001',
  operator: 'Jane'
);
```
...
**card:** `Payroc::Payments::Cards::Types::BalanceInquiryCard` — Object that contains information about the card.
...
<details><summary><code>client.payments.cards.lookup_bin(request) -> Payroc::Types::CardInfo</code></summary>
<dl>
<dd>
...
```ruby
client.payments.cards.lookup_bin(processing_terminal_id: '1234001');
```
</dd>
</dl>
</dd>
...
**card:** `Payroc::Payments::Cards::Types::BinLookupCard` — Object that contains information about the card.
...
<details><summary><code>client.payments.currency_conversion.retrieve_fx_rates(request) -> Payroc::Types::FxRate</code></summary>
<dl>
<dd>
...
**channel:** `Payroc::Payments::CurrencyConversion::Types::FxRateInquiryChannel` — Channel that the merchant used to receive payment details for the transaction.
...
**payment_method:** `Payroc::Payments::CurrencyConversion::Types::FxRateInquiryPaymentMethod` — Object that contains information about the customer's payment details.
...
<details><summary><code>client.payments.bank_transfer_payments.list() -> Payroc::Types::BankTransferPaymentPaginatedList</code></summary>
<dl>
<dd>
...
**type:** `Payroc::Payments::BankTransferPayments::Types::ListBankTransferPaymentsRequestTypeItem` — Filter results by transaction type.
...
**status:** `Payroc::Payments::BankTransferPayments::Types::ListBankTransferPaymentsRequestStatusItem` — Filter results by the status of the payment.
...
**settlement_state:** `Payroc::Payments::BankTransferPayments::Types::ListBankTransferPaymentsRequestSettlementState` — Filter results by the settlement status.
...
<details><summary><code>client.payments.bank_transfer_payments.create(request) -> Payroc::Types::BankTransferPayment</code></summary>
<dl>
<dd>
...
**payment_method:** `Payroc::Payments::BankTransferPayments::Types::BankTransferPaymentRequestPaymentMethod` — Object that contains information about the customer's payment details.
...
<details><summary><code>client.payments.bank_transfer_payments.retrieve(payment_id) -> Payroc::Types::BankTransferPayment</code></summary>
<dl>
<dd>
...
```ruby
client.payments.bank_transfer_payments.retrieve(payment_id: 'M2MJOG6O2Y');
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.payments.bank_transfer_payments.reverse(payment_id) -> Payroc::Types::BankTransferPayment</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.bank_transfer_payments.refund(payment_id, request) -> Payroc::Types::BankTransferPayment</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payments.bank_transfer_payments.represent(payment_id, request) -> Payroc::Types::BankTransferPayment</code></summary>
<dl>
<dd>
...
**payment_method:** `Payroc::Payments::BankTransferPayments::Types::RepresentmentPaymentMethod` — Object that contains information about the customer's payment details.
...
<details><summary><code>client.payments.bank_transfer_refunds.list() -> Payroc::Types::BankTransferRefundPaginatedList</code></summary>
<dl>
<dd>
...
```ruby
client.payments.bank_transfer_refunds.list(
  processing_terminal_id: '1234001',
  order_id: 'OrderRef6543',
  name_on_account: 'Sarah%20Hazel%20Hopper',
  last_4: '7062',
...
**type:** `Payroc::Payments::BankTransferRefunds::Types::ListBankTransferRefundsRequestTypeItem` — Filter results by transaction type.
...
**status:** `Payroc::Payments::BankTransferRefunds::Types::ListBankTransferRefundsRequestStatusItem` — Filter results by the status of the refund.
...
**settlement_state:** `Payroc::Payments::BankTransferRefunds::Types::ListBankTransferRefundsRequestSettlementState` — Filter results by the settlement status.
...
<details><summary><code>client.payments.bank_transfer_refunds.create(request) -> Payroc::Types::BankTransferRefund</code></summary>
<dl>
<dd>
...
```ruby
client.payments.bank_transfer_refunds.create(
  idempotency_key: '8e03978e-40d5-43e8-bc93-6894a57f9324',
  processing_terminal_id: '1234001',
  order: {
    order_id: 'OrderRef6543',
...
**refund_method:** `Payroc::Payments::BankTransferRefunds::Types::BankTransferUnreferencedRefundRefundMethod` — Object that contains information about how the merchant refunds the customer.
...
<details><summary><code>client.payments.bank_transfer_refunds.retrieve(refund_id) -> Payroc::Types::BankTransferRefund</code></summary>
<dl>
<dd>
...
```ruby
client.payments.bank_transfer_refunds.retrieve(refund_id: 'CD3HN88U9F');
```
</dd>
</dl>
</dd>
...
<details><summary><code>client.payments.bank_transfer_refunds.reverse(refund_id) -> Payroc::Types::BankTransferRefund</code></summary>
<dl>
<dd>
...
```ruby
client.payments.bank_transfer_refunds.reverse(
  refund_id: 'CD3HN88U9F',
  idempotency_key: '8e03978e-40d5-43e8-bc93-6894a57f9324'
);
```
...
<details><summary><code>client.payments.bank_accounts.verify(request) -> Payroc::Types::BankAccountVerificationResult</code></summary>
<dl>
<dd>
...
```ruby
client.payments.bank_accounts.verify(
  idempotency_key: '8e03978e-40d5-43e8-bc93-6894a57f9324',
  processing_terminal_id: '1234001'
);
```
...
**bank_account:** `Payroc::Payments::BankAccounts::Types::BankAccountVerificationRequestBankAccount` — Object that contains information about the bank account.
...
<details><summary><code>client.payments.payment_links.sharing_events.list(payment_link_id) -> Payroc::Types::SharingEventPaginatedList</code></summary>
<dl>
<dd>
...
```ruby
client.payments.payment_links.sharing_events.list(
  payment_link_id: 'JZURRJBUPS',
  recipient_name: 'Sarah Hazel Hopper',
  recipient_email: 'sarah.hopper@example.com',
  before: '2571',
...
<details><summary><code>client.payments.payment_links.sharing_events.share(payment_link_id, request) -> Payroc::Types::PaymentLinkEmailShareEvent</code></summary>
<dl>
<dd>
...
```ruby
client.payments.payment_links.sharing_events.share(
  payment_link_id: 'JZURRJBUPS',
  idempotency_key: '8e03978e-40d5-43e8-bc93-6894a57f9324'
);
```
...
<details><summary><code>client.payroc_cloud.payment_instructions.submit(serial_number, request) -> Payroc::Types::PaymentInstruction</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payroc_cloud.payment_instructions.retrieve(payment_instruction_id) -> Payroc::Types::PaymentInstruction</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payroc_cloud.payment_instructions.delete(payment_instruction_id) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.payroc_cloud.refund_instructions.submit(serial_number, request) -> Payroc::Types::RefundInstruction</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payroc_cloud.refund_instructions.retrieve(refund_instruction_id) -> Payroc::Types::RefundInstruction</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payroc_cloud.refund_instructions.delete(refund_instruction_id) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.payroc_cloud.signature_instructions.submit(serial_number, request) -> Payroc::Types::SignatureInstruction</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payroc_cloud.signature_instructions.retrieve(signature_instruction_id) -> Payroc::Types::SignatureInstruction</code></summary>
<dl>
<dd>
...
<details><summary><code>client.payroc_cloud.signature_instructions.delete(signature_instruction_id) -> </code></summary>
<dl>
<dd>
...
<details><summary><code>client.reporting.settlement.list_batches() -> Payroc::Reporting::Settlement::Types::ListBatchesSettlementResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.reporting.settlement.retrieve_batch(batch_id) -> Payroc::Types::Batch</code></summary>
<dl>
<dd>
...
<details><summary><code>client.reporting.settlement.list_transactions() -> Payroc::Reporting::Settlement::Types::ListTransactionsSettlementResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.reporting.settlement.retrieve_transaction(transaction_id) -> Payroc::Types::Transaction</code></summary>
<dl>
<dd>
...
<details><summary><code>client.reporting.settlement.list_authorizations() -> Payroc::Reporting::Settlement::Types::ListAuthorizationsSettlementResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.reporting.settlement.retrieve_authorization(authorization_id) -> Payroc::Types::Authorization</code></summary>
<dl>
<dd>
...
<details><summary><code>client.reporting.settlement.list_disputes() -> Payroc::Reporting::Settlement::Types::ListDisputesSettlementResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.reporting.settlement.list_disputes_statuses(dispute_id) -> Internal::Types::Array[Payroc::Types::DisputeStatus]</code></summary>
<dl>
<dd>
...
<details><summary><code>client.reporting.settlement.list_ach_deposits() -> Payroc::Reporting::Settlement::Types::ListAchDepositsSettlementResponse</code></summary>
<dl>
<dd>
...
<details><summary><code>client.reporting.settlement.retrieve_ach_deposit(ach_deposit_id) -> Payroc::Types::AchDeposit</code></summary>
<dl>
<dd>
...
<details><summary><code>client.reporting.settlement.list_ach_deposit_fees() -> Payroc::Reporting::Settlement::Types::ListAchDepositFeesSettlementResponse</code></summary>
<dl>
<dd>
